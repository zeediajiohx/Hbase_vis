var maps=echarts.init(document.getElementById("c2"),"light");
var ecc_world_option={
    ...
    visualMap:{
        type:"piecewise",
        pieces:[
            {min:1000000000,max:10000000000,label:">=10亿",color:"#fc8c03"},
            {min:500000000, max:999999999,label:"5亿-10亿",color:"#f6c11a"},
            {min:100000000, max:499999999,label:"1亿-5亿",color:"#f6e24e"},
            {min:40000000,  max:99999999,label:"4千万-1亿",color:"#f3e98f"},
            {min:10000000,  max:69999999,label:"1千万-4千万",color:"#faefb5"},
            {min:5000000,   max:9999999,label:"5百万-1千万",color:"#faedcb"},
            {min:600000,    max:4999999,label:"60万-5百万",color:"#faf1de"},
            {min:0,         max:599999,label:"60万以下",color:"#f6f1e3"},],
        textStyle:{
    ...
    series:[
        {
            ...
            mapType:"world",
            roam:true,
            itemStyle:{emphasis:{areaColor:"#894343",label:{color:'#ffffff',show:true}}},
            data:[
